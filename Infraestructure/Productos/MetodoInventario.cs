   ...
   public class MetodoInventario
    {
        ...
        {
            Producto[] arr = productoModel.FindAll();
            ...
            {
                if (e.Naturaleza == Domain.Enums.NaturalezaCunt.Entrada)
                {
                    Add(e, arrEntradas);
                }
                else if (e.Naturaleza == Domain.Enums.NaturalezaCunt.Salida)
                {
                    Add(e, arrSalidas);
                }
            }
        ...
        public int[] GetExistencias()
        {
            ...
            {
                if (arr[i].Naturaleza == Domain.Enums.NaturalezaCunt.Entrada)
                {
                    existenciaAux += arr[i].Existencia;
                }
                else if (arr[i].Naturaleza == Domain.Enums.NaturalezaCunt.Salida)
                {
                    existenciaAux -= arr[i].Existencia;
                }
